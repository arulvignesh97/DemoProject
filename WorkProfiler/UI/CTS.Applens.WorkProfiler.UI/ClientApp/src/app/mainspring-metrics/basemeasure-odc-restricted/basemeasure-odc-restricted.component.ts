...
@Component({
  selector: 'app-basemeasure-odc-restricted',
  templateUrl: './basemeasure-odc-restricted.component.html',
  styleUrls: ['./basemeasure-odc-restricted.component.css']
})
export class BasemeasureOdcRestrictedComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {    
    ...
    this.basemeasures = JSON.parse(JSON.stringify(this.basemeasurecomp.basemeasuresOdcModel));
  }
  ngOnChanges() {
  ...
  SaveBaseMeasureODC(): void {
    ...
    .subscribe(result => {
      ...
      if (result == "Success") {
        ...
        this.basemeasurecomp.GetBaseMeasureProjectwiseSearchODC(true);      
      } else {
  ...
  clearAllFilters(): void {
    this.clearGrid();    
    this.basemeasurecomp.GetBaseMeasureProjectwiseSearchODC(false);
